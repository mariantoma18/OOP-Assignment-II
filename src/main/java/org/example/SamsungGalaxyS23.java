...
public class SamsungGalaxyS23 extends Samsung {
  ...
  private static final String IMEI = "25 345678 901234 1";
  private int currentBatteryLife = super.getBatteryLife();

  public SamsungGalaxyS23(String material, String color) {
  ...
  public void call(String callPhoneNumber) {
    System.out.println(
        "You have called the phone number: " + callPhoneNumber + " from your Samsung Galaxy S23.");
