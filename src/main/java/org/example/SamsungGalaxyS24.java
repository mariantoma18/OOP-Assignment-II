...
public class SamsungGalaxyS24 extends Samsung {

  private static final String IMEI = "25 456789 012345 7";
  private int currentBatteryLife = super.getBatteryLife();

  public SamsungGalaxyS24(String material, String color) {
  ...
  public void call(String callPhoneNumber) {
    System.out.println(
        "You have called the phone number: " + callPhoneNumber + " from your Samsung Galaxy S24.");
