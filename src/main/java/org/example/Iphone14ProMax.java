...
public class Iphone14ProMax extends Iphone {
  ...
  private static final String IMEI = "35 123456 789012 8";
  private int currentBatteryLife = super.getBatteryLife();

  public Iphone14ProMax(String material, String color) {
  ...
  public void call(String callPhoneNumber) {
    System.out.println(
        "You have called the phone number: " + callPhoneNumber + " from your Iphone 14 Pro Max .");
